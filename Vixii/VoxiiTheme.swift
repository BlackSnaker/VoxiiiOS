...
final class VoxiiAppearance: ObservableObject {
    ...
    @Published var language: VoxiiLanguage {
        didSet {
            ...
            UserDefaults(suiteName: VoxiiWidgetShared.appGroupID)?.set(language.rawValue, forKey: Keys.language)
            scheduleRefresh()
        }
    }
    ...
    init() {
        ...
        UserDefaults(suiteName: VoxiiWidgetShared.appGroupID)?.set(savedLanguage.rawValue, forKey: Keys.language)
    ...
    private static let translations: [VoxiiLanguage: [String: String]] = [
        .en: [
            ...
            "dm.subtitle": "Priority chats, unread messages, and instant access.",
            ...
            "dm.filter.friends": "Friends",
            "dm.filter.online": "Online",
            "dm.metric.unread": "Unread",
            "dm.metric.online": "Online",
            "dm.metric.friends": "Friends",
            "dm.section.active": "Conversations",
            "dm.section.filtered": "Filtered list",
            "dm.row.open": "Open chat",
            ...
            "settings.liveActivities": "Dynamic Island",
            "settings.liveActivitiesSubtitle": "Test Live Activities for messages and calls",
            "settings.liveActivitiesAvailable": "Live Activities available",
            "settings.liveActivitiesUnavailable": "Live Activities unavailable",
            "settings.liveActivitiesDelay": "Starts in 5 sec",
            "settings.testMessageActivity": "Message Test",
            "settings.testMessageActivityHint": "Shows a compact message preview in Dynamic Island and on the Lock Screen.",
            "settings.runMessageActivityTest": "Run Message Test",
            "settings.testCallActivity": "Call Test",
            "settings.testCallActivityHint": "Shows a call-style Live Activity and closes it automatically after a short time.",
            "settings.runCallActivityTest": "Run Call Test",
            "settings.liveActivitiesMessageScheduled": "Message test scheduled. Dynamic Island will appear in 5 seconds.",
            "settings.liveActivitiesMessageShown": "Message Live Activity started.",
            "settings.liveActivitiesCallScheduled": "Call test scheduled. Dynamic Island will appear in 5 seconds.",
            "settings.liveActivitiesCallShown": "Call Live Activity started.",
            "settings.liveActivitiesTestSender": "Voxii Test",
            "settings.liveActivitiesTestCaller": "Voxii Call Test",
            "settings.liveActivitiesTestBody": "This is a test message preview for Dynamic Island.",
        ...
        .ru: [
            ...
            "dm.subtitle": "Приоритетные чаты, непрочитанные сообщения и быстрый доступ.",
            ...
            "dm.filter.all": "Все",
            "dm.filter.unread": "Непрочитанные",
            "dm.filter.friends": "Друзья",
            "dm.filter.online": "Онлайн",
            "dm.metric.unread": "Непрочитано",
            "dm.metric.online": "Онлайн",
            "dm.metric.friends": "Друзья",
            "dm.section.active": "Диалоги",
            "dm.section.filtered": "Отфильтрованный список",
            "dm.row.open": "Открыть чат",
            ...
            "call.accept": "Принять",
            "call.controlMic": "Мик",
            "call.controlCamera": "Камера",
            "call.controlEnd": "Сброс",
            ...
            "settings.liveActivities": "Dynamic Island",
            "settings.liveActivitiesSubtitle": "Тест Live Activities для сообщений и звонков",
            "settings.liveActivitiesAvailable": "Live Activities доступны",
            "settings.liveActivitiesUnavailable": "Live Activities недоступны",
            "settings.liveActivitiesDelay": "Запуск через 5 сек",
            "settings.testMessageActivity": "Тест сообщения",
            "settings.testMessageActivityHint": "Показывает компактное превью сообщения в Dynamic Island и на экране блокировки.",
            "settings.runMessageActivityTest": "Запустить тест сообщения",
            "settings.testCallActivity": "Тест звонка",
            "settings.testCallActivityHint": "Показывает Live Activity в стиле звонка и автоматически закрывает её через короткое время.",
            "settings.runCallActivityTest": "Запустить тест звонка",
            "settings.liveActivitiesMessageScheduled": "Тест сообщения запланирован. Dynamic Island появится через 5 секунд.",
            "settings.liveActivitiesMessageShown": "Live Activity сообщения запущена.",
            "settings.liveActivitiesCallScheduled": "Тест звонка запланирован. Dynamic Island появится через 5 секунд.",
            "settings.liveActivitiesCallShown": "Live Activity звонка запущена.",
            "settings.liveActivitiesTestSender": "Тест Voxii",
            "settings.liveActivitiesTestCaller": "Тест звонка Voxii",
            "settings.liveActivitiesTestBody": "Это тестовое превью сообщения для Dynamic Island.",
